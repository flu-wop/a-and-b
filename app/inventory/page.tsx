...
const CATEGORIES = [
  ...
  },
  {
    ...
    description:
      "We regularly acquire full warehouse lots and machine shop liquidations — a constantly changing selection of parts that don't fit neatly into one category.",
    examples: [
      "Electric motors",
      "Material handling",
